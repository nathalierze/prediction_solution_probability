...
For fairness evaluations the best models (MLP and DTE), and the worst model (SVM) are considered. A random state is not set, thus, results might differ marginally.
